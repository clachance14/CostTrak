-- Per Diem Fix FINAL: Winner Takes All Allocation
-- Fixed all syntax issues - all output statements properly wrapped
...
SELECT 
  '📅 WEEKLY BREAKDOWN' as report_type,
...
BEGIN
  ...
  INTO total_amount, total_records
  FROM public.per_diem_costs;
  
  RAISE NOTICE '';
  RAISE NOTICE '========================================';
  RAISE NOTICE '🎉 PER DIEM FIX COMPLETE!';
  RAISE NOTICE '========================================';
  RAISE NOTICE 'Total Records: %', total_records;
  RAISE NOTICE 'Total Amount: $%', total_amount;
  RAISE NOTICE '';
  RAISE NOTICE 'The per diem has been calculated using the';
  RAISE NOTICE '"Winner Takes All" approach:';
  RAISE NOTICE '- Each employee gets max 1 per diem per day';
  RAISE NOTICE '- Project with most hours wins the week';
  RAISE NOTICE '- Rate: $120/day for all employees';
  RAISE NOTICE '========================================';
END $$;