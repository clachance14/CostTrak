...
import { SoftDeleteDialog } from '@/components/project/soft-delete-dialog'
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              {/* Temporarily removed controller check for testing */}
              <DropdownMenu>
              ...
              <CardHeader>
                <CardTitle className="flex items-center justify-between">
                  ...
                  {canEdit && (
                    <Button 
                      size="sm"
                      onClick={() => router.push(`/projects/${id}/budget-import-coversheet`)}
                    >
                      <FileText className="h-4 w-4 mr-2" />
                      Import from Coversheet
                    </Button>
                  )}
                </CardTitle>
              </CardHeader>
